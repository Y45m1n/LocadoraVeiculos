...
<a href="indexFuncionario.php"><i class="fas fa-home"></i>Home Funcionario</a>
	...
	<div class="pagination">
		<?php if ($page > 1): ?>
		<a href="listarCliente.php?page=<?=$page-1?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
		<?php endif; ?>
		<?php if ($page*$records_per_page < $num_contacts): ?>
		<a href="listarCliente.php?page=<?=$page+1?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
		<?php endif; ?>
	</div>
</div>
