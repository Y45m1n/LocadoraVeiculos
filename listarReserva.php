...
// Preparar a instrução SQL para obter as locações
$stmt = $pdo->prepare('SELECT locacao.*, carro.placa, carro.modelo, cliente.nome, cliente.celular 
                        FROM locacao
                        INNER JOIN carro ON locacao.id_carro = carro.id_carro
                        INNER JOIN cliente ON locacao.id = cliente.id
    ...
    <table>
        <thead>
            <tr>
                ...
                <td>Data Locação <form method="GET">
